...
document.querySelector("#iti-item-cn").onclick = function(){
    ...
    window.location="https://www.finereport.com/product/active";
...
function select_change() {
    if (document.getElementById("JOB").value == "115") {
...
var otherInput = document.getElementById('others_indeed2');
var other = document.getElementById('others_indeed');
...
function otherFun() {
    ...
    otherInput.onblur = function(){
        if (other.style.display == 'block') {
            otherInput.style.borderColor = "#2e7fff";
            if (otherInput.value == '') {
                setErrorFor(otherInput);
            } else {
                setSuccessFor(otherInput);
            }
    ...
    otherInput.onfocus = function(){
        ...
        var img=otherInput.parentElement.querySelector('#no_success');
        var img2=otherInput.parentElement.querySelector('#yes_success');
        img.style.display='none';
        img2.style.display='none';
        if (otherInput.parentNode.lastChild.nodeName.toLowerCase() == "p") {
            otherInput.parentNode.lastChild.remove();
        }
    }
}
    ...
    for (var i = 0; i < form_control.length; i++) {
        ...
        userdata[i].onblur= function () {
            ...
            if(this.value == ''&& this.index == 7){
                ...
                if (this.index == 0 && other.style.display == 'none') { //name
                    setSuccessFor(this);
                }
...
$(".next1").click(function(){
    if(checkInputs1()==3) {
        var list1 = $("#form1").serialize();
        var otherInputValue = otherInput.value.trim();
        var list1 = list1 + "&otherInput" + otherInputValue;
        alert(list1);
...
$(".next2").click(function(){
    ...
    if(checkInputs2() == 6) {
        ...
        if(telValue !='' &&companyValue !='' && emailvalue != '' && jobValue != '' && methodValue != '' && sizeValue != '' && goalValue != ''){
            // $.ajax({
            //     type: 'GET',
            //     async: true,
            //     dataType: 'json',
